...
#' 
df.Goods_size <- na.omit(read_excel(paste0(getwd, "/KOAS_BoxPacking_INPUT.xlsx"), sheet = "Goods_size"))
df.Truck_spec <- na.omit(read_excel(paste0(getwd, "/KOAS_BoxPacking_INPUT.xlsx"), sheet = "Truck_spec."))
